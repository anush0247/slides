...
\normalsize	
 \url{\\ 21 Years, Male \\
 Emp Id: 1007721, TCS ILP Trainee - AHD\\
 aneesh.thangella@tcs.com 
}
\begin{flushright}
 \url{+91 9160883374} \\
 \url{anush0247@gmail.com} \\
 \url{https://github.com/anush0247} \\
 \url{https://in.linkedin.com/in/anush0247}
...
\textit{2011 -- 2015 } & B.Tech in Computer Science, at RGUKT -- Nuzvid, \textbf{CGPA -- 9.03 / 10.0}.\\
...
\begin{tabular}{L!{\VRule}R}
\textit{ May, 2015}&{\bf TCS ILP Trainee at Ahmedabad, Gujarat} \\
&  Started working in TCS as Assistant System Engineer-Trainee from 25th May, 2015\\
&  \textit{Stream : } Java, \textit{Batch: } AHD03 - 1516, \textit{Learning Group :} AJA10
\end{tabular}
\newline \linebreak \\
\begin{tabular}{L!{\VRule}R}
